      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10 sm:mb-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
            <span className="inline-flex items-center gap-2 rounded-full border border-slate-200/70 bg-white/70 backdrop-blur px-4 py-2 text-xs sm:text-sm text-slate-700 shadow-sm">
              ...
              >
                <div className="group h-full rounded-[28px] border border-slate-200/70 bg-white/75 backdrop-blur shadow-[0_18px_60px_rgba(2,6,23,0.08)] overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 flex items-center justify-between gap-3 rounded-2xl border border-slate-200/70 bg-white/70 backdrop-blur p-4">
                      <div>
                      ...
                      <Link
                        to="/apply"
                        className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary/90 transition"
                      >
                        Apply now
